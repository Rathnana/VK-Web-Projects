...
export default function EditReport({ setSuccess, id, reports }) {
    ...
    const updateDailyConstruct = async (data) => {
        ...
        return await axios.post(
            `${process.env.React_App_URL}/update/updateDailyConstructByIdAdmin.php`, params,
            {
                headers: {
                            ...
                            {fields.map(({ key, name, fieldKey, ...restField }, index) => (
                                <div key={key} >
                                    <Row gutter={10}>
                                        <Col xs={24}>
                                            <p style={{ fontSize: 20 }}>
                                                {(index) >= report?.team?.length && <AiFillCloseCircle style={{ fontSize: 18 }} className="remove-class zoom-bigger" onClick={() => remove(name)} />}&emsp;
                                        ...
                                        <Col xs={24} lg={24}>
                                            ...
                                            >
                                                <Input type="text" placeholder='ការងារអនុវត្តន៍' size="large" allowClear />
                                            </Form.Item>
                                        ...
                                        <Col xs={24} lg={24}>
                                            ...
                                            >
                                                <TextArea placeholder='លទ្ធផល' size="large" allowClear />
                                            </Form.Item>
                                            <Divider />
                                        </Col>
                                    </Row>
                            ...
                            <br />
                            {
                                startImage !== null ?
                                    ...
                                    <Image
                                        ...
                                        width={200}
                                        height={200}
                                        src={reports?.startImage ? `${process.env.React_App_IMAGES}/${reports?.startImage}` : "error"}
                            ...
                            <br />
                            {
                                resultImage !== null ?
                                    ...
                                    <Image
                                        ...
                                        width={200}
                                        height={200}
                                        src={reports?.resultImage ? `${process.env.React_App_IMAGES}/${reports?.resultImage}` : "error"}
                                        fallback="data:image/png;base64,"
                                    />
                            }
